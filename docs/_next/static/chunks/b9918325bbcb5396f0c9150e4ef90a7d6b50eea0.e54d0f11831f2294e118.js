    ...
    CxY0: function(t, e, n) {
      ...
      (i.prototype.parse = function(t, e, n) {
        ...
        if (b) {
          ...
          (this.protocol = _), (w = w.substr(b.length));
        }
        if (n || b || w.match(/^\/\/[^@\/]+@[^@\/]+/)) {
          var j = "//" === w.substr(0, 2);
          !j || (b && m[b]) || ((w = w.substr(2)), (this.slashes = !0));
        }
        if (!m[b] && (j || (b && !y[b]))) {
        ...
        (i.prototype.resolveObject = function(t) {
          ...
          k &&
            ...
            (R = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@")) &&
              ((n.auth = R.shift()), (n.host = n.hostname = R.shift())));
          return (
            (b = b || (n.host && j.length)) && !S && j.unshift(""),
            j.length
              ? (n.pathname = j.join("/"))
        ...
        !(function(i) {
          ...
          function I(t) {
            ...
            for (o = n > 0 ? n + 1 : 0; o < x; ) {
              ...
              (O = S(b - i, (e = w.length + 1), 0 == i)),
                _(b / e) > u - j && k("overflow"),
                (j += _(b / e)),
                (b %= e),
                w.splice(b++, 0, j);
            }
                ...
                value: function(e, r, o, u) {
                  ...
                  return new s(function(s, h) {
                    ...
                    t.events.emit("routeChangeStart", p),
                      c.getRouteInfo(O, _, j, p, C).then(function(n) {
                        var r = n.error;
